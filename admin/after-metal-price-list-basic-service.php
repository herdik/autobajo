...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if ($_POST["btn"] === "OK"){
        $update_alu_basic_service = MetalWheelBasicService::updateMetalWheelBasicService($connection, $metal_wheel_id, $type, $price);
        $redirect_fault = true;
    } elseif ($_POST["btn"] === "X"){
        $delete_alu_basic_service = MetalWheelBasicService::deleteMetalWheelBasicService($connection, $metal_wheel_id);
        $redirect_fault = true;
    } 
    ...
    $create_new_line = MetalWheelBasicService::createMetalWheelBasicService($connection);
