...
if ($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    $adhesive_weight_id = $_POST["adhesive_weight_id"];
    $type = $_POST["type"];
    $price = $_POST["price"];

    if ($_POST["btn"] === "OK"){
        $update_alu_basic_service = AdhesiveWeight::updateAdhesiveWeight($connection, $adhesive_weight_id, $type, $price);
        $redirect_fault = true;
    } elseif ($_POST["btn"] === "X"){
        $delete_alu_basic_service = AdhesiveWeight::deleteAdhesiveWeight($connection, $adhesive_weight_id);
        $redirect_fault = true;
    } 
    ...
    $create_new_line = AdhesiveWeight::createAdhesiveWeight($connection);
