...
if (isset($_GET["tire_wheel_id"]) and is_numeric($_GET["tire_wheel_id"])){
    ...
    $tire_images = TireWheelImage::getAllTireWheelsImages($connection, $tire_wheel_id);
} else {
    $tire_wheel_id = null;
    $tire_images = null;
}
...
<body>
    ...
    <main>
        ...
        <section class="add-new-images">
            <form id="registration-form-images" action="./after-add-del-title-tire-wheel-img-gallery.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="tire_wheel_id" value="<?= htmlspecialchars($tire_wheel_id) ?>">
        ...
        <section class="add-new-images">
            <form id="registration-form-image" action="./after-add-del-title-tire-wheel-img-gallery.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="tire_wheel_id" value="<?= htmlspecialchars($tire_wheel_id) ?>">
        ...
        <section class="admin-gallery">
                ...
                <div class="add-delete">
                    ...
                    <div class="add-part">
                        ...
                        <form class="edit-form" action="./after-add-del-title-tire-wheel-img-gallery.php" method="POST">
            ...
            <article class="images-part" id="sortable">
                    ...
                    <div class="div-menu-images ui-state-default">
                        ...
                        <?php else: ?>
                            ...
                            <img src="../uploads/tireswithwheels/<?= htmlspecialchars($tire_wheel_id) ?>/<?= htmlspecialchars($tire_image["image_name"]) ?>" alt="">
                        <?php endif; ?>
    ...
    <script src="../js/choose-tire-wheel-image-gallery.js"></script>   
    <script src="../js/sortable-gallery-tire-wheel.js"></script> 
